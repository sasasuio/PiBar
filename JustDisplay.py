...
draw.text((8,15), '>Shot Tequila',font = font)
draw.text((8,23), 'Tequila Sunrise',font = font)
draw.text((8,31), 'Vodka Sunrise',font = font)
draw.text((8,39), 'Vodka Naranja',font = font)
imprimir_en_pantalla()
sleep(2)
limpiar_pantalla()
draw.text((8,23), 'Seleccione Nivel:',font = font)
draw.text((8,31), 'Suave',font = font)
draw.text((8,39), 'Medio',font = font)
draw.text((8,23), 'Ingeniería',font = font)
imprimir_en_pantalla()
